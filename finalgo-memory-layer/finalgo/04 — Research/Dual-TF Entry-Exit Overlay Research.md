...
- Real cross-sectional percentile ranks (full-universe re-score each 15m bar) — **not** raw margin scores (see the single-ticker degeneracy finding in [[06 — Logs/Daily Logs/2026-06-11|today's Daily Log]]).
