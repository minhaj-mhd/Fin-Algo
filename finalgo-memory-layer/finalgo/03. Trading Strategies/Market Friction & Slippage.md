...
## 👁️ Key Related Notes
*   See the strategy parameter configurations: [[03. Trading Strategies/Strategy Catalog|Strategy Catalog]].
*   See how exit charges are computed dynamically: [[04. Data & Code Map/Shadow Tracker & Execution Loop|Shadow Tracker & Execution Loop]].
*   Review our database schema for fee auditing: [[04. Data & Code Map/Database Architecture|Database Architecture]].
