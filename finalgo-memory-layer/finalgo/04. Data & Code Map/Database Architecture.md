...
## 👁️ Key Related Notes
*   See how the live scanner logs trades and calculates quantity: [[04. Data & Code Map/Shadow Tracker & Execution Loop|Shadow Tracker & Execution Loop]].
*   See how the AI Veto audits trades and edits database rows: [[04. Data & Code Map/AI Veto & Gemini Audit|AI Veto & Gemini Audit]].
*   Check the dashboard code in scripts: [[04. Data & Code Map/Codebase File Directory|Codebase File Directory]].
