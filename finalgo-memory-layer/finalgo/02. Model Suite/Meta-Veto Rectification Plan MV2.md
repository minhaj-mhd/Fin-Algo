...
> **Supersedes**: the voided first build (see audit banner on [[08. Model Analysis/Meta-Veto/Certification Report]]). Parent spec [[02. Model Suite/Meta-Veto Stacking Framework Plan]] still binds except where amended here.
...
## 🔗 Backlinks
- Voided first attempt: [[08. Model Analysis/Meta-Veto/Certification Report]] (audit banner)
- Parent spec: [[02. Model Suite/Meta-Veto Stacking Framework Plan]]
