...
The simulator has completed its run and outputted the side-by-side performance matrix. You can view the full mathematical breakdown in the **[[03 — Strategies/Empirical Regime Simulation Results|Empirical Regime Simulation Results]]** document.
