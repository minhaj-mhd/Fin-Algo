...
*   **[[02. Model Suite/Model Inference Data Structure|Model Inference Data Structure]]**: Master specification for the 54-feature vector used by `xgb_long_model` and `xgb_short_model` at inference time.
...
*   **[[03. Trading Strategies/Strategy Catalog|Strategy Catalog]]**: The comprehensive catalog of our 10 backtested trading strategies, highlighting Strategy 8 (ORB) and Strategy 10 (Quad-TF).
...
*   **[[03. Trading Strategies/Strategy March 2026 Revision|Strategy March 2026 Revision]]**: Analysis of the directionally correct Spearman correlation shift, Golden Hour (post-2:15 PM) trading, and Volatility Pause filters.
...
*   **[[04. Data & Code Map/Shadow Tracker & Execution Loop|Shadow Tracker & Execution Loop]]**: The runtime execution rules (Dynamic ATR-based Take Profit, 1h Hard-Close, 15:15 IST EOD flush).
*   **[[04. Data & Code Map/AI Veto & Gemini Audit|AI Veto & Gemini Audit]]**: Details of the live sentiment verification, Support/Resistance calculation, and trade auditing system.
...
### 📚 5. Archives
*   **`05. Archives/`**: A folder containing individual, modular markdown files for all retired and obsolete systems (e.g., Vanguard V1, Dual-Specialist concepts). We use individual files here instead of a monolithic ledger for better searchability in Obsidian, while still keeping them physically separated from active codebase documentation.
