...
## 📌 Metadata
- **Run ID**: `20260610T110022Z-5f7d069f`
- **Evaluated At (UTC)**: `2026-06-10T11:03:48.678208+00:00`
...
- **Multiple Testing Context**: Prior runs for dataset family = `5`
- **Deflated t-Threshold**: `2.6383` (corrected for `6` total tests)
...
> [!IMPORTANT]
> Deflated t-threshold is **`2.64`**. Values exceeding this are marked with ✷.
