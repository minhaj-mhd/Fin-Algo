---
title: "Validation Gauntlet Report: `v19_catboost_1h"
type: report
status: active
...
tags: []
---
# 🛡️ Validation Gauntlet Report: `v19_catboost_1h`

## 📌 Metadata
- **Run ID**: `20260610T191237Z-d795438c`
- **Evaluated At (UTC)**: `2026-06-10T19:20:55.093485+00:00`
...
- **Multiple Testing Context**: Prior runs for dataset family = `41`
- **Deflated t-Threshold**: `3.2412` (corrected for `42` total tests)
...
> [!IMPORTANT]
> Deflated t-threshold is **`3.24`**. Values exceeding this are marked with ✷.
