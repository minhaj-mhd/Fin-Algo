...
- **Downstream Model**: `v3_15min_clean` (Run ID: `20260610T113721Z-5f7d069f`)
...
> [!WARNING]
> **Gating Certification has FAILED for v3_15min_clean across all modes.** Gating does not provide a statistically significant, cost-adjusted return uplift. Production integration is rejected.
