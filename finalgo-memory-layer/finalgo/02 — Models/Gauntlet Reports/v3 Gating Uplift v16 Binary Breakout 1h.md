---
title: "Gating Uplift Certification Report: `v16_binary_breakout_1h"
type: reference
status: active
...
tags: []
---
# 🛡️ Gating Uplift Certification Report: `v16_binary_breakout_1h`

## 📌 Metadata
- **Daily Model**: `daily_macro_v3` (Run ID: `20260610T144343Z-5f7d069f`)
- **Downstream Model**: `v16_binary_breakout_1h` (Run ID: `20260610T121609Z-5f7d069f`)
...
> [!WARNING]
> **Gating Certification has FAILED for v16_binary_breakout_1h across all modes.** Gating does not provide a statistically significant, cost-adjusted return uplift. Production integration is rejected.
