...
## 👁️ Key Related Notes
*   See how daily macro trend models are trained: [[01 — Architecture/Data & Code/Codebase File Directory|Codebase File Directory]].
*   See where the models are loaded: [[02 — Models/_Shared/Model Registry & File Structures|Model Registry & File Structures]].
*   Review our dynamic 15M ATR calculations: [[01 — Architecture/Execution & Runtime/Shadow Tracker & Execution Loop|Shadow Tracker & Execution Loop]].
