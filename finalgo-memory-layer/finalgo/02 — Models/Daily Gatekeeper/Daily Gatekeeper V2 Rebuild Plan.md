...
> **Prereqs**: [[01 — Architecture/Validation Gauntlet/Validation Gauntlet Architecture]] and [[01 — Architecture/Validation Gauntlet/Validation Gauntlet Remediation Plan]] — all Gauntlet conventions bind. Read both before starting.
...
## 🔗 Backlinks
- Evidence: Gauntlet run `20260610T102743Z-5f7d069f` (daily_xgb DEAD autopsy) — see [[06 — Logs/Daily Logs/2026-06-10]]
- Harness: [[01 — Architecture/Validation Gauntlet/Validation Gauntlet Architecture]] · [[01 — Architecture/Validation Gauntlet/Validation Gauntlet Remediation Plan]]
- Verdict expectations: [[02 — Models/_Shared/Model Performance & Statistics]]
