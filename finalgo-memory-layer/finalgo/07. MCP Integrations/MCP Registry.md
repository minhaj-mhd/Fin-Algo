...
* **Target 1**: **Database Connector (SQLite)** - To query trade logs and historical tick data directly. *(Status: 🟢 Connected - [[07. MCP Integrations/SQLite MCP Setup|Docs]])*
* **Target 2**: **Jupyter / Python Data Sandbox** - To securely backtest and plot model performance directly in the workspace. *(Status: Setting Up - [[07. MCP Integrations/Jupyter MCP Setup|Docs]])*

### Phase 2: Workflow & Deployment
* **Target 3**: **Obsidian Memory Engine** - For semantic search and safe markdown edits. *(Status: ⏸️ Deferred (Using Native Filesystem) - [[07. MCP Integrations/Obsidian MCP Setup|Research Docs]])*
