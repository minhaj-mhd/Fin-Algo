        ...
        for bar_idx, T in enumerate(unique_15m_times):
            ...
            if strategy_id == 6:
                ...
                for t in active_trades:
                    ...
                    trailing_stop = 0.010  # 1% trailing stop for EVERY strategy
                    sl_pct = None  # Replaced by trailing stop
                    tp_pct = None
                    
                    # Removed specific SL/TP assignments for the experiment
                    t_dt = pd.to_datetime(T)
                    sub_5m = [t_dt, t_dt + timedelta(minutes=5), t_dt + timedelta(minutes=10)]
                    ...
                    for t5 in sub_5m:
                        ...
                        if t['side'] == 'LONG':
                            ...
                            if trailing_stop and t['peak_pnl'] - l_pnl >= trailing_stop:
                                ...
                                exit_price = b5['close']  # Close at the end of the 5m candle
                                break
                        else:
                            # Short side
