"""
Train daily macro XGBoost ranking models using Walk-Forward Validation.
...
- Saves final models, walk-forward metadata, and scaler to models/daily_xgb/
"""
...
print("=" * 60)
print("DAILY MACRO XGBOOST RANKER TRAINING PIPELINE")
...
params = {
    ...
    'eta': 0.02,              # Slower eta for stable macro predictions
...
# ========================================
print("\n" + "=" * 60)
print("RUNNING WALK-FORWARD VALIDATION ON DAILY MACRO TRENDS")
print("=" * 60)
...
for cfg in folds_config:
    ...
    bst_long = xgb.train(
        params, dtrain_long, num_boost_round=800,
    ...
    bst_short = xgb.train(
        params, dtrain_short, num_boost_round=800,
...
bst_prod_long = xgb.train(
    params, dtrain_prod_long, num_boost_round=800,
...
bst_prod_short = xgb.train(
    params, dtrain_prod_short, num_boost_round=800,
...
print("\n" + "=" * 60)
print("DAILY MACRO XGBOOST TRAINING COMPLETE")
