"""
v15 - LambdaMART with NDCG@3 Early Stopping.

This model keeps the rank:ndcg objective and quantile-based graded relevance.
It uses 'ndcg@3' for early stopping (since we only care about the top 3 picks).
"""
...
MODEL_DIR = 'models/v15_lambdamart_es_1h'
COST      = 0.0010
TOP_K     = 5
...
# ── data ───────────────────────────────────────────────────────────────────────
print("=" * 64)
print("v15 LAMBDAMART - EARLY STOPPING (ndcg@3)")
print("=" * 64)
...
metadata = {
    'description':  'v15 - LambdaMART with ndcg@3 early stopping',
    'type':         'lambdamart_es_ndcg3',
