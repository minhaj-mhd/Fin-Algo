...
MODEL_DIR   = 'models/v17_random_forest_1h'
COST        = 0.0010
...
# ── data ───────────────────────────────────────────────────────────────────────
print("=" * 64)
print(f"v17 RANDOM FOREST CLASSIFIER (>{int(BREAKOUT_TH*10000)} bps target)")
print("=" * 64)
...
metadata = {
    'description':  'v17 - Random Forest Classifier (>20bps target)',
